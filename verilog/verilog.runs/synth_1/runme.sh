...
HD_PWD='C:/Users/kaust/OneDrive/Documents/DESIGN LAB/verilog/verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log convLayerSingle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source convLayerSingle.tcl
